...
Public Class FindKidProgress
    ...
    Private Sub Btn_Evaluation_Click(sender As Object, e As EventArgs) Handles Btn_Evaluation.Click
        If Not String.IsNullOrEmpty(Cb_Name.Text) Then
            Dim frm As New DataVisualization(Cb_Name.Text) ' Pasa el valor directamente a la pantalla de Visualizacion de progreso del Infante
            Hide()
            frm.Show()
        Else
